...
def generateSchool(classesperGrade, numberOfGrades, numTeachersPerClass): #input: number of students at school and grades. Primary school == 7, junior high school == 3. 
    klasse = 0
