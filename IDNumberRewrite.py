...
'''
dayOne = pandas.read_csv('dayOnePrimaryLunch.csv', header=None)
dayTwo = pandas.read_csv('dayTwoPrimaryLunch.csv', header = None)
metadata = pandas.read_csv('metadata_primaryschool.txt', delimiter='\t', header = None)
dayOne.columns = ['Time', 'SourceID', 'TargetID', 'SourceClass', 'TargetClass', 'NumberOfInteractions']
dayTwo.columns = ['Time', 'SourceID', 'TargetID', 'SourceClass', 'TargetClass', 'NumberOfInteractions']
...
metadata.reset_index(drop=True, inplace=True)
'''
dayOne = pandas.read_csv('dayOnePrimaryLunch10minClass5.csv', header=None)
dayTwo = pandas.read_csv('dayOnePrimaryLunch10minClass5.csv', header = None)
metadata = pandas.read_csv('metadata_primaryschool.txt', delimiter='\t', header = None)
dayOne.columns = ['Time', 'SourceID', 'TargetID', 'SourceClass', 'TargetClass', 'NumberOfInteractions']
dayTwo.columns = ['Time', 'SourceID', 'TargetID', 'SourceClass', 'TargetClass', 'NumberOfInteractions']
...
dayOne.to_csv('dayOneNewIndexLunch10minClass5.csv', header = None, index = False)
dayTwo.to_csv('dayTwoNewIndexPrimaryLunch10minClass5.csv', header = None, index = False)